...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Game Time.py"

        #Name of program
        self.project_name = "SeXyMoN Game"
        ...
        self.license = "My Shiz"

        #Auhor of program
        self.author_name = "Anthony Rolland"
        self.author_email = "example@example.com"
        self.copyright = "Copyright (c) 2014 Mah Shiz industries."

        #Description
        self.project_description = "Defeat the sexymon before they defeat you!"

        #Icon file (None will use pygame default icon)
        self.icon_file = None

        #Extra files/dirs copied to game
        self.extra_datas = ["..//Slay the Dragon//Graphics", "..//Slay the Dragon//Sound"]

        #Extra/excludes python modules
        self.extra_modules = ["..//Slay the Dragon//Player.py","..//Slay the Dragon//Button.py"]
