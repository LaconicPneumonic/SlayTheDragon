...
while again:
    ...
    while not done:
        ...
        if Knight.Score == Score_max and Dragon.mouthx == 121:
        ...
        if boss_level:
            ...
            for ki in Dragon.Shots:
                ...
                if kirect.colliderect(Knight_rect):
                   ...
                   Knight.Health -= 2
                   Sexymon_Hit.play()
                if ki[0]>700 or ki[0]< - 100:
                    ki[3] = False
                elif ki[1] > 500 or ki[1] < -50:
                    ki[3] = False
        ...
        for bullet in Shots:
            ...
            if bullet[0]<-64 or bullet[0]>700 or bullet[1]<-64 or bullet[1]>500:
                bullet[3] = False
            if boss_level:
